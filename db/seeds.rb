...
meatballs = Recipe.create!(name: 'Meatballs with chicory puree', description: "Fresh meatballs made with love", prep_time: 12, cooking_time: 35, category: asian, photo:"https://res.cloudinary.com/dqsodpjur/image/upload/v1522417621/g9nsax3ovit3cpc2byno.jpg" )
...
d7 = Dose.create!(ingredient: "Butter", quantity: 2, unit:"t.s.", step: s3 )
d8 = Dose.create!(ingredient: "Balsamic vinegar", quantity: 2, unit:"t.s.", step: s3 )
d5 = Dose.create!(ingredient: "Chicory", quantity: 300, unit:"g", step: s4 )
d6 = Dose.create!(ingredient: "Cheese", quantity: 50, unit:"g", step: s5 )
d9 = Dose.create!(ingredient: "Milk", unit:"t.y.o.t", step: s5 )
d10 = Dose.create!(ingredient: "Pepper", unit:"t.y.o.t", step: s5 )
d11 = Dose.create!(ingredient: "Salt", unit:"t.y.o.t", step: s5 )
